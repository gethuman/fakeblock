...
Fakeblock.prototype.filterConditions = function (conditions) {
    ...
    if (allowedFields.length !== conditionFields.length) {
        throw new Error('User does not have permission to use query criteria: ' +
            JSON.stringify(_.without(conditionFields, allowedFields)));
    }
